<template>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div v-for="kategori in state" :key="kategori.id"
          ...
          <a href="#"
            ...
            <router-link class="container" :to="{ name: 'ElektronikComponent', params: { id_produk: kategori.id } }">
              <h4>{{ kategori.nama }}</h4>
            </router-link>
  ...
  export default {
    ...
    .card {
      box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); /* Fixed the rgba syntax */
      transition: 0.3s;
      margin: 10px;
      min-width: 200px;
      cursor: pointer;
    ...
    .card:hover {
      box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2); /* Fixed the rgba syntax */
    }
